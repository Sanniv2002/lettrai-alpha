...
import { Brain, Bot, Sparkles, Stars, Cpu } from 'lucide-react';
...
const flowIcons = {
  ...
  openai_api: { icon: Stars, label: 'OpenAI', color: 'text-green-400' },
  deepseek_api: { icon: Cpu, label: 'DeepSeek', color: 'text-orange-400' },
...
export function JobCard({ job, onViewResult }: JobCardProps) {
  ...
  return (
    <motion.div
      ...
      className="glass-container p-6 rounded-xl border border-white/10 hover:border-purple-500/20 transition-all duration-200"
    >
